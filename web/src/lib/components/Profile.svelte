      ...
      <div class='overflow-hidden'>
        ...
        {:else} <!-- TODO: diamond registration form -->
            ...
            {#if $accountChainId.chainId === 5}
              <p>
                Need test currency? Go to a <a href={`https://goerlifaucet.com/`} target="_blank">faucet</a>, or <a href="https://twitter.com/tjvsx" target="_blank">ask me to send you some</a>.
              </p>
            {/if}
        {/if}
      </div>
